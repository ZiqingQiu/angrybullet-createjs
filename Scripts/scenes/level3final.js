...
var scenes;
(function (scenes) {
    var Level3FinalScene = /** @class */ (function (_super) {
        __extends(Level3FinalScene, _super);
        //public properties
        //constructors
        function Level3FinalScene() {
        ...
        //private methods
        Level3FinalScene.prototype.afterTimeout = function () {
            this.removeChild(this._warnLabel);
            this._boss3.SetEnable(true);
        };
        Level3FinalScene.prototype.delay = function () {
        ...
        Level3FinalScene.prototype.CheckCollisionWOBullet = function () {
            ...
            if (this._boss3.alpha == 1) {
                managers.Collision.Check(this._player, this._boss3);
            }
        };
        Level3FinalScene.prototype.CheckPlayerBullet = function () {
            var _this = this;
            ...
            for (var idx = 0; idx < bulletIdxArray.length; idx++) {
                ...
                bullets.forEach(function (bullet) {
                    if (bullet.alpha == 1 && _this._boss3.alpha == 1) {
                        //check collision player-bullet -- boss
                        managers.Collision.Check(bullet, _this._boss3);
                    }
                });
            }
        };
        Level3FinalScene.prototype.CheckEnemyBullet = function () {
            var _this = this;
            var bulletIdxArray = [];
            var bullets = [];
            //check collision with tie's bullets
            bulletIdxArray = managers.Game.bulletManager.GetTotalBulletTypes("boss_bullet_lv3");
            for (var idx = 0; idx < bulletIdxArray.length; idx++) {
                bullets = managers.Game.bulletManager.GetBullets("boss_bullet_lv3", bulletIdxArray[idx]);
                bullets.forEach(function (bullet) {
                    if (bullet.alpha == 1) {
        ...
        //public methods
        Level3FinalScene.prototype.Start = function () {
            this._space = new objects.Space("space_lv2");
            this._boss3 = new objects.LevelBOSS("boss_lv3", "boss_bullet_lv3", 70);
            this._boss3.alpha = 0;
        ...
        Level3FinalScene.prototype.Update = function () {
            ...
            //update HP;
            this._bossHPLabel.text = "boss hp " + this._boss3.getHP();
        };
        Level3FinalScene.prototype.Destroy = function () {
            this._engineSound.stop();
            this.removeAllChildren();
        };
        Level3FinalScene.prototype.Main = function () {
            var _this = this;
            ...
            this.addChild(this._boss3);
            //add bullets to the scene
            managers.Game.bulletManager.RegisterBullet(this, "boss_bullet_lv3");
        ...
        return Level3FinalScene;
    }(objects.Scene));
    scenes.Level3FinalScene = Level3FinalScene;
})(scenes || (scenes = {}));
//# sourceMappingURL=level3final.js.map