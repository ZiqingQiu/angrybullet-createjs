...
(function () {
    ...
    textureAtlasData = {
        ...
        "animations": {
            "blt_boss_bomb": { "frames": [0, 1, 2],"speed": 0.1 },
            "blt_enemy_laser_lv1": { "frames": [3] },
            "blt_player_laser_lv1": { "frames": [4] },
            "blt_player_laser_lv2": { "frames": [5, 6, 7, 8],"speed": 0.2 },
            "blt_player_rocket_lv1": { "frames": [9, 10, 11, 12, 13],"speed": 0.1 },
            ...
            "power_up_S": { "frames": [55] },
            "slaveI": { "frames": [56] },
            "smallexplosion": { "frames": [57, 58, 59, 60, 61, 62] },
            "tie": { "frames": [63] }
        }   
